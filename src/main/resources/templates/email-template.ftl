    ...
    <style>
        * {
        ...
        @media (max-width: 660px) {
            ...
            .image_block img.big, .row-content {
                width: 100% !important
            }
    ...
    <tr>
        <td>
            <table class="row row-1" align="center" width="100%" border="0" cellpadding="0" cellspacing="0"
                   role="presentation"
                   style="mso-table-lspace:0;mso-table-rspace:0;background-color:#1aa19c">
                <tbody>
                <tr>
                    <td>
                        <table class="row-content stack" align="center" border="0" cellpadding="0" cellspacing="0"
                               role="presentation"
                               style="mso-table-lspace:0;mso-table-rspace:0;color:#000;background-color:#1aa19c;width:640px"
                               width="640">
                            <tbody>
                            <tr>
                                <td class="column column-1" width="100%"
                                    ...
                                    <table class="divider_block block-1" width="100%" border="0" cellpadding="0"
                ...
                <tr>
                    <td>
                        <table class="row-content stack" align="center" border="0"
                               ...
                               style="mso-table-lspace:0;mso-table-rspace:0;color:#000;width:640px" width="640">
                            <tbody>
                            <tr>
                                <td class="column column-1" width="100%"
                                    ...
                                    <table class="image_block block-1" width="100%" border="0" cellpadding="0"
                                        ...
                                        <tr>
                                            <td class="pad" style="width:100%;padding-right:0;padding-left:0">
                                                <div class="alignment" align="center" style="line-height:10px"><a
                                                ...
                                                <div style="font-family:Arial,sans-serif">
                                                    <div class="txtTinyMce-wrapper"
                                                        ...
                                                        <p style="margin:0;font-size:16px;text-align:center">
                                                            <span style="font-size:30px;color:#2b303a;"><strong>${body}</strong></span>
                                                        </p></div>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td class="pad"
                                                ...
                                                <div style="font-family:sans-serif">
                                                    <div class="txtTinyMce-wrapper"
                                                        ...
                                                        <p style="margin:0;font-size:14px;text-align:center">Mã xác minh
                                                            dùng để truy cập Tài khoản với gmail: ${email}</p>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                    <table class="button_block block-5" width="100%" border="0" cellpadding="0"
                                           cellspacing="0" role="presentation"
                                           style="mso-table-lspace:0;mso-table-rspace:0">
                                        <tr>
                                            <td
            ...
            <table class="row row-4" align="center" width="100%" border="0" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td>
                        <table class="row-content stack" align="center" border="0" cellpadding="0" cellspacing="0"
                               role="presentation"
                               style="mso-table-lspace:0;mso-table-rspace:0;color:#000;background-color:#410125;width:640px"
                               width="640">
                            <tbody>
                            <tr>
                                <td class="column column-1" width="100%"
                                    ...
                                    <table class="social_block block-2" width="100%" border="0" cellpadding="0"
                                           cellspacing="0" role="presentation"
                                           style="mso-table-lspace:0;mso-table-rspace:0">
                                        <tr>
                                            <td class="pad"
                                                ...
                                                <div class="alignment" style="text-align:center">
                                                    <table class="social-table" width="208px" border="0" cellpadding="0"
                                                           cellspacing="0" role="presentation"
                                    ...
                                    <table class="divider_block block-3" width="100%" border="0" cellpadding="0"
                                           cellspacing="0" role="presentation"
                                           style="mso-table-lspace:0;mso-table-rspace:0">
                                        <tr>
                                            <td class="pad"
                                                ...
                                                <div style="font-family:sans-serif">
                                                    <div class="txtTinyMce-wrapper"
                                                        ...
                                                        <p style="margin:0;font-size:14px;text-align:center"><span
                                                                    style="color:#95979c;font-size:12px;">Your Logo Copyright © 2021</span>
                                                        </p>
                                                        <p style="margin:0;font-size:14px;text-align:center"><span
                                                                    style="color:#95979c;font-size:12px;">Want to stop receiving these emails?</span>
                                                        </p>
                                                        <p
                                                                style="margin:0;font-size:14px;text-align:center"><span
                                                                    style="color:#95979c;font-size:12px;"> <a
                                                                        target="_blank"
                                                                        style="text-decoration: underline; color: #ffffff;"
                                                                        rel="noopener">Unsubscribe </a></span></p></div>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
            ...
            <table class="row row-5" align="center" width="100%" border="0" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td>
                        <table class="row-content stack" align="center" border="0" cellpadding="0" cellspacing="0"
                               role="presentation" style="mso-table-lspace:0;mso-table-rspace:0;color:#000;width:640px"
                               width="640">
                            <tbody>
                            <tr>
                                <td class="column column-1" width="100%"
                                                        ...
                                                        <td class="alignment"
                                                            ...
                                                            <table class="icons-inner"
                                                                ...
                                                                <tr>
                                                                    <td
                                                                        ...
                                                                        <a
                                                                                ...
                                                                                style="text-decoration: none;"><img
                                                                                    class="icon" alt="Designed with BEE"
                                                                    ...
                                                                    <td
                                                                            style="font-family:Montserrat,Trebuchet MS,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Tahoma,sans-serif;font-size:15px;color:#9d9d9d;vertical-align:middle;text-align:center">
                                                                        <a
                                                                                target="_blank"
                                                                                style="color: #9d9d9d; text-decoration: none;">Shop </a>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
